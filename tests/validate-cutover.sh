...
grep -q '^version: 0.9.12$' "$ROOT/switch-vision-snmp2mqtt/config.yaml"
grep -q '^ARG CORE_VERSION=v0.9.12$' "$ROOT/switch-vision-snmp2mqtt/Dockerfile"
grep -q '^ARG CORE_COMMIT=e9a961f25fd3eb205321d8494c596911fa97fc49$' "$ROOT/switch-vision-snmp2mqtt/Dockerfile"
...
grep -q 'CORE_VERSION=v0.9.12' "$ROOT/.github/workflows/build.yml"
grep -q 'CORE_COMMIT=e9a961f25fd3eb205321d8494c596911fa97fc49' "$ROOT/.github/workflows/build.yml"
