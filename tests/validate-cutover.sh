...
grep -q '^version: 1.0.3$' "$ROOT/switch-vision-snmp2mqtt/config.yaml"
...
grep -q '^ARG CORE_VERSION=v1.0.2$' "$ROOT/switch-vision-snmp2mqtt/Dockerfile"
grep -q '^ARG CORE_COMMIT=1e1f4b78b399ba0f3257043f29ffdfcce95f82c6$' "$ROOT/switch-vision-snmp2mqtt/Dockerfile"
...
grep -q 'CORE_VERSION=v1.0.2' "$ROOT/.github/workflows/publish-release.yml"
grep -q 'CORE_COMMIT=1e1f4b78b399ba0f3257043f29ffdfcce95f82c6' "$ROOT/.github/workflows/publish-release.yml"
